...
public class MakeTempCardInDrawPileFreeAction extends com.megacrit.cardcrawl.actions.AbstractGameAction {
	private AbstractCard cardToMake;
	private boolean randomSpot = false;
	private boolean cardOffset = false;

	public MakeTempCardInDrawPileFreeAction(AbstractCreature target, AbstractCreature source, AbstractCard card,
