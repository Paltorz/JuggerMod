...
public class Juggernaut extends CustomPlayer {
	...
	public Juggernaut(String name, PlayerClass setClass) {
	...
	public static CharSelectInfo getLoadout() {
		return new CharSelectInfo("Juggernaut", "A fearless behemoth. He has weathered countless blows, and dealt countless more.",
				90, 90, 99, 5,
