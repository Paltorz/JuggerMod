...
import juggermod.powers.GigaImpactPower;

public class GigaImpact extends CustomCard{
    public static final String ID = "Giga Impact";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new GigaImpactPower(1), 1));
    }
